            ...
            "/v1/transcode": {
                "post": {
                    ...
                    "parameters": [
                        ...
                        qp("video_bitrate", "string", "Bitrate for every rung without its own @RATE, e.g. 3M (software H.264 / H.265)."),
                        qp("video_buffer", "string", "Coded picture buffer for the bitrate rungs, e.g. 1s or 500ms (0 for none)."),
