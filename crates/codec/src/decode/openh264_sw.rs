...
//!
//! Compiles unconditionally. `openh264-fallback` gates whether
//! [`create_decoder_on`](super::create_decoder_on) falls back here once the
//! hardware tiers have declined — a policy question, not a capability one, and
//! the same arrangement as the AV1 fallback.
//!
